import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_C0JoQuUH.mjs';
import 'kleur/colors';
import './server_DeHU3RnB.mjs';
import 'clsx';
...
}, "/home/sabre/dev/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const SPAIN = "ES";
  const contry = Astro2.request.headers.get("X-Vercel-IP-Country") ?? SPAIN;
